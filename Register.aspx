                    ...
                    <div class="main3">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="a2" id="s_realname" name="s_realname" size="20" maxlength="20" onfocus="this.style.borderColor='#239fe3'" onblur="this.style.borderColor='#dcdcdc'" placeholder="请填写真实姓名" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="a2" id="y_carId" name="y_carId" size="20" maxlength="20" onfocus="this.style.borderColor='#239fe3'" onblur="this.style.borderColor='#dcdcdc'" placeholder="请填写身份证号码" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="a2" id="pwd" name="pwd" size="20" maxlength="20" onfocus="this.style.borderColor='#239fe3'" onblur="this.style.borderColor='#dcdcdc'" placeholder="请填写六位数字密码" /></td>
                            </tr>
                            <tr>
                                <td width="100" class="a1">确认密码：</td>
                                <td>
                                    <input type="text" class="a2" id="pwd2" name="pwd2" size="20" maxlength="20" onfocus="this.style.borderColor='#239fe3'" onblur="this.style.borderColor='#dcdcdc'" placeholder="请再次输入密码" /></td>
                            </tr>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         ...
                                         <select name="schoolId" id="schoolId" class="a2" style="width: 200px; float: left;">
                                             ...
                                             <%--  <%
                                        var type1 = DbHelperSQL.Query("select * from  S_School ").Tables[0];
                                        for (var i = 0; i < type1.Rows.Count; i++)
                                        {%>
                                    <option value="<%=type1.Rows[i]["id"] %>"><%=type1.Rows[i]["y_schoolName"] %></option>
                                    <%} %>--%>
                                         </select>
                            ...
                            <tr>
                                <td width="100"></td>
                                <td>
                                    <input type="button" value="提交" id="ttit" onclick="Alogin()" class="tj" />
                                    <a href="/" class="tj" style="background: none; border: 1px solid #2f93fc; color: #2f93fc; display: block; float: right; line-height: 36px; height: 36px; margin-right: 70px;">返回登录</a>
